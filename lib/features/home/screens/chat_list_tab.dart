...
import 'package:flutter_app/features/home/widgets/chat_list_tile.dart';
import 'package:flutter/material.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';
import 'package:provider/provider.dart' as p;

/// A widget that displays the list of all user chats.
///
/// It uses [ConsumerWidget] to listen to [chatListProvider] from Riverpod.
...
class ChatListTab extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // This is the CRITICAL step to make them work together.
    ...
    return ProviderScope(
      ...
      child: Consumer(
        builder: (context, ref, child) {
          ...
          final asyncChatList = ref.watch(chatListProvider);

          // Handle the different states of the FutureProvider
          return asyncChatList.when(
